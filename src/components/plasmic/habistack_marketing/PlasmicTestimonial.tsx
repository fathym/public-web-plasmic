...
import * as sty from "./PlasmicTestimonial.module.css"; // plasmic-import: nVmiel2bCFzTx/css

import smalljpgEcimYoRrHbuKqg from "./images/smalljpg.jpeg"; // plasmic-import: EcimYoRrHbuKqg/picture
...
function PlasmicTestimonial__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.column__lqCkW)}>
        <h2
        ...
        >
          <div className={classNames(projectcss.all, sty.column__dsReA)}>
            <p.PlasmicImg
          ...
          <div className={classNames(projectcss.all, sty.column__nko4)}>
            <h5
