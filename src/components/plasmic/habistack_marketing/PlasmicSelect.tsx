...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: ax6DBbIWfKzD9/component
import Select__Option from "../../Select__Option"; // plasmic-import: eKExsNHrdJcjNn/component
...
import * as sty from "./PlasmicSelect.module.css"; // plasmic-import: 1AnVVfOvWn5evs/css

import ChevronDownsvgIcon from "./icons/PlasmicIcon__ChevronDownsvg"; // plasmic-import: WUx9jGSrP_-NjU/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: gZU1PMm9BATysb/icon
  ...
  if (!("children" in props)) {
    props = {
      ...
      children: (
        <React.Fragment>
          <Select__Option
            className={classNames("__wab_instance", sty.option__igfmK)}
            value={"value1" as const}
          >
            {"Option 1"}
          </Select__Option>
          ...
          <Select__Option
            className={classNames("__wab_instance", sty.option__zthSm)}
            value={"value2" as const}
          >
            {"Option 2"}
          </Select__Option>
