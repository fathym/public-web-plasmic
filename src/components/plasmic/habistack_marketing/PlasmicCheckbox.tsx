...
import * as sty from "./PlasmicCheckbox.module.css"; // plasmic-import: ym62TQ_aygnMS/css

import SquaresvgIcon from "./icons/PlasmicIcon__Squaresvg"; // plasmic-import: FcMEUV2vhUS3Dw/icon
import SquareCheckFilledsvgIcon from "./icons/PlasmicIcon__SquareCheckFilledsvg"; // plasmic-import: DVNunvbtidCq1z/icon
import SquareMinussvgIcon from "./icons/PlasmicIcon__SquareMinussvg"; // plasmic-import: ETIvr20_R-AjxU/icon
