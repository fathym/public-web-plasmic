...
import * as sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: -F1_4lcMaG19/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: 1AnVVfOvWn5evs/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option___67T79)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__up0WT)}
              />
            </React.Fragment>
          ),
          value: args.children
