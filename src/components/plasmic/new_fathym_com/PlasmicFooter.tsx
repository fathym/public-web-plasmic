...
import TextInput2 from "../../TextInput2"; // plasmic-import: MeQWELtrysB/component
import Button2 from "../../Button2"; // plasmic-import: aLoaIkI4766/component
import IconLink from "../../IconLink"; // plasmic-import: ayEd-ezB3C-z/component
...
import * as sty from "./PlasmicFooter.module.css"; // plasmic-import: Q4yy3X_W7vH/css
...
function PlasmicFooter__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__oOk7)} />

      <p.PlasmicImg
        alt={"" as const}
        className={classNames(sty.img__gGosq)}
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__rzWk)}
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__voFf)}
        >
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__glCo0)}
          >
            <div
              className={classNames(
                projectcss.all,
          ...
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox___8Pmho)}
          >
            <div
              className={classNames(
                projectcss.all,
          ...
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__zt4Ue)}
          >
            <div
              className={classNames(
                projectcss.all,
          ...
          {true ? (
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox__qjXas)}
            >
              <div
                className={classNames(
                  projectcss.all,
              ...
              <TextInput2
                ...
                endIcon={
                  <Button2
                    ...
                    startIcon={
                      <IconIcon
                        className={classNames(projectcss.all, sty.svg__tr4Ep)}
                        role={"img"}
                      />
                    }
                  >
                    <IconIcon
                      className={classNames(projectcss.all, sty.svg__xAzu)}
                      role={"img"}
                    />
                  </Button2>
                }
      ...
      <div className={classNames(projectcss.all, sty.freeBox__pn52J)} />

      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__pcRgL)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__rntZi)}>
          <div
            className={classNames(
              projectcss.all,
              projectcss.__wab_text,
          ...
          <p.PlasmicImg
            alt={""}
            className={classNames(sty.img__uAvr)}
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__bVYqb)}
        >
          <IconLink
