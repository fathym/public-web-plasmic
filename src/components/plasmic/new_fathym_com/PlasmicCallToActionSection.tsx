...
import * as sty from "./PlasmicCallToActionSection.module.css"; // plasmic-import: mTFy8Vt80PPU/css
...
import meetingMOAaQnMqXtbQ from "./images/meeting.jpeg"; // plasmic-import: mOAaQnMqXtbQ/picture
...
function PlasmicCallToActionSection__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox___1XOvW)}>
        <div
        ...
        <div className={classNames(projectcss.all, sty.freeBox__ieDrS)}>
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__gP9Sx)}
          >
            <p.Stack
              as={"div"}
                ...
                defaultContents: (
                  <React.Fragment>
                    <p.Stack
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__hSkU0)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
                    ...
                    <p.Stack
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__gy9B)}
                    >
                      <Button
                        className={classNames(
                          "__wab_instance",
