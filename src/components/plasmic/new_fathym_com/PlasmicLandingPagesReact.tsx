...
import * as sty from "./PlasmicLandingPagesReact.module.css"; // plasmic-import: YHHsIHIZ309X/css
...
export function Head() {
  return (
    <>
      ...
      <title key="title">{PlasmicLandingPagesReact.pageMetadata.title}</title>
      <meta
        key="og:title"
        property="og:title"
        content={PlasmicLandingPagesReact.pageMetadata.title}
      />
      <meta
        key="twitter:title"
        name="twitter:title"
      ...
      <meta
        key="description"
        name="description"
        content={PlasmicLandingPagesReact.pageMetadata.description}
      />
      <meta
        key="og:description"
      ...
      <meta
        key="og:image"
        property="og:image"
        content={PlasmicLandingPagesReact.pageMetadata.ogImageSrc}
      />
      <meta
        key="twitter:image"
        name="twitter:image"
          ...
          >
            ...
            >
              ...
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__aQ83)}
              >
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__dObkk)}
                >
                  <ValueProp
                    className={classNames(
                      "__wab_instance",
            ...
            <Banner
              ...
              left={
                <React.Fragment>
                  ...
                  <div
                    className={classNames(projectcss.all, sty.columns__hS4XO)}
                  >
                    <div
                      className={classNames(projectcss.all, sty.column__wuQm0)}
                    >
                      <Button
                        className={classNames(
                          "__wab_instance",
                    ...
                    <div
                      className={classNames(projectcss.all, sty.column___648PK)}
                    >
                      <p.PlasmicLink
                        className={classNames(
                          projectcss.all,
