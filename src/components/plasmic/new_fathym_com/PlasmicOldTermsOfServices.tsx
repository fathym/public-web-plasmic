...
import * as sty from "./PlasmicOldTermsOfServices.module.css"; // plasmic-import: 4hgTMGuV5F0/css
...
export function Head() {
  return (
    <>
      ...
      <title key="title">{PlasmicOldTermsOfServices.pageMetadata.title}</title>
      <meta
        key="og:title"
        property="og:title"
