...
import * as sty from "./PlasmicOldPrivacyPolicy.module.css"; // plasmic-import: 8Fxhz1anqdV/css

import image209KpgErbsBxF from "./images/image20.jpeg"; // plasmic-import: 9kpgErbsBxF/picture
import image21NBnZzJilEMu from "./images/image21.jpeg"; // plasmic-import: NBnZzJilEMu/picture

export type PlasmicOldPrivacyPolicy__VariantMembers = {};

export type PlasmicOldPrivacyPolicy__VariantsArgs = {};
type VariantPropType = keyof PlasmicOldPrivacyPolicy__VariantsArgs;
export const PlasmicOldPrivacyPolicy__VariantProps =
  new Array<VariantPropType>();

export type PlasmicOldPrivacyPolicy__ArgsType = {};
type ArgPropType = keyof PlasmicOldPrivacyPolicy__ArgsType;
export const PlasmicOldPrivacyPolicy__ArgProps = new Array<ArgPropType>();

export type PlasmicOldPrivacyPolicy__OverridesType = {
  root?: p.Flex<"div">;
...
export interface DefaultOldPrivacyPolicyProps {
  className?: string;
}
...
export function Head() {
  return (
    <>
      ...
      <title key="title">{PlasmicOldPrivacyPolicy.pageMetadata.title}</title>
      <meta
        key="og:title"
        property="og:title"
        content={PlasmicOldPrivacyPolicy.pageMetadata.title}
      />
      <meta
        key="twitter:title"
        name="twitter:title"
      ...
      <meta
        key="description"
        name="description"
        content={PlasmicOldPrivacyPolicy.pageMetadata.description}
      />
      <meta
        key="og:description"
      ...
      <meta
        key="og:image"
        property="og:image"
        content={PlasmicOldPrivacyPolicy.pageMetadata.ogImageSrc}
      />
      <meta
        key="twitter:image"
        name="twitter:image"
...
function PlasmicOldPrivacyPolicy__RenderFunc(props: {
  variants: PlasmicOldPrivacyPolicy__VariantsArgs;
  args: PlasmicOldPrivacyPolicy__ArgsType;
  overrides: PlasmicOldPrivacyPolicy__OverridesType;
                  ...
                  >
                    <p.PlasmicImg
                      ...
                      src={
                        hasVariant(globalVariants, "screen", "mobileOnly")
                          ? {
                              src: image21NBnZzJilEMu,
                              fullWidth: 1920,
                              fullHeight: 1280,
                              aspectRatio: undefined
                            }
                          : {
                              src: image209KpgErbsBxF,
                              fullWidth: 1920,
                              fullHeight: 1280,
                              aspectRatio: undefined
                            }
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicOldPrivacyPolicy__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicOldPrivacyPolicy__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    // Specify args directly as props
    Omit<PlasmicOldPrivacyPolicy__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicOldPrivacyPolicy__ArgProps,
          internalVariantPropNames: PlasmicOldPrivacyPolicy__VariantProps
        }),
      [props, nodeName]
    );

    return PlasmicOldPrivacyPolicy__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicOldPrivacyPolicy";
  } else {
    func.displayName = `PlasmicOldPrivacyPolicy.${nodeName}`;
  }
  return func;
}

export const PlasmicOldPrivacyPolicy = Object.assign(
  // Top-level PlasmicOldPrivacyPolicy renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicOldPrivacyPolicy
    internalVariantProps: PlasmicOldPrivacyPolicy__VariantProps,
    internalArgProps: PlasmicOldPrivacyPolicy__ArgProps,
...
export default PlasmicOldPrivacyPolicy;
/* prettier-ignore-end */
