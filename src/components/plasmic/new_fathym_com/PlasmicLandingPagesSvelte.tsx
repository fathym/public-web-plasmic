...
import * as sty from "./PlasmicLandingPagesSvelte.module.css"; // plasmic-import: yPO2dsHR0-Dj/css
...
export function Head() {
  return (
    <>
      ...
      <title key="title">{PlasmicLandingPagesSvelte.pageMetadata.title}</title>
      <meta
        key="og:title"
        property="og:title"
        content={PlasmicLandingPagesSvelte.pageMetadata.title}
      />
      <meta
        key="twitter:title"
        name="twitter:title"
      ...
      <meta
        key="description"
        name="description"
        content={PlasmicLandingPagesSvelte.pageMetadata.description}
      />
      <meta
        key="og:description"
      ...
      <meta
        key="og:image"
        property="og:image"
        content={PlasmicLandingPagesSvelte.pageMetadata.ogImageSrc}
      />
      <meta
        key="twitter:image"
        name="twitter:image"
          ...
          >
            ...
            >
              ...
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__xhd3Z)}
              >
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__fmrSy)}
                >
                  <ValueProp
