...
import * as sty from "./PlasmicLandingPagesAngular2Test.module.css"; // plasmic-import: zA550Sjzi3Z/css
...
export function Head() {
  return (
    <>
      ...
      <title key="title">
        {PlasmicLandingPagesAngular2Test.pageMetadata.title}
      </title>
      <meta
        key="og:title"
        property="og:title"
        content={PlasmicLandingPagesAngular2Test.pageMetadata.title}
      />
      <meta
        key="twitter:title"
        name="twitter:title"
      ...
      <meta
        key="description"
        name="description"
        content={PlasmicLandingPagesAngular2Test.pageMetadata.description}
      />
      <meta
        key="og:description"
      ...
      <meta
        key="og:image"
        property="og:image"
        content={PlasmicLandingPagesAngular2Test.pageMetadata.ogImageSrc}
      />
      <meta
        key="twitter:image"
        name="twitter:image"
            ...
            >
              ...
              >
                ...
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__agWuV)}
                >
                  <p.Stack
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__dIeF)}
                  >
                    {(
              ...
              <Banner
                ...
                left={
                  <React.Fragment>
                    ...
                    <div
                      className={classNames(projectcss.all, sty.columns__bqfFd)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
