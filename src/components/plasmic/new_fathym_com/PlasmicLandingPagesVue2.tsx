...
import * as sty from "./PlasmicLandingPagesVue2.module.css"; // plasmic-import: vqYcrTrm6F4/css
...
export function Head() {
  return (
    <>
      ...
      <title key="title">{PlasmicLandingPagesVue2.pageMetadata.title}</title>
      <meta
        key="og:title"
        property="og:title"
        content={PlasmicLandingPagesVue2.pageMetadata.title}
      />
      <meta
        key="twitter:title"
        name="twitter:title"
      ...
      <meta
        key="description"
        name="description"
        content={PlasmicLandingPagesVue2.pageMetadata.description}
      />
      <meta
        key="og:description"
      ...
      <meta
        key="og:image"
        property="og:image"
        content={PlasmicLandingPagesVue2.pageMetadata.ogImageSrc}
      />
      <meta
        key="twitter:image"
        name="twitter:image"
          ...
          >
            ...
            >
              ...
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__m2EhW)}
              >
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__bjQoj)}
                >
                  <Reveal
            ...
            <Banner
              ...
              left={
                <React.Fragment>
                  ...
                  <div
                    className={classNames(projectcss.all, sty.columns__fbV5T)}
                  >
                    <div
                      className={classNames(projectcss.all, sty.column__dwPvi)}
                    >
                      <Button
                        className={classNames(
                          "__wab_instance",
                    ...
                    <div
                      className={classNames(projectcss.all, sty.column__nttTb)}
                    >
                      <p.PlasmicLink
                        className={classNames(
                          projectcss.all,
