...
import * as sty from "./PlasmicTestimonial.module.css"; // plasmic-import: ckCiVMtRuKmU/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__zb42F)}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__zeb1Q)}
      >
        <p.PlasmicImg
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__oySyJ)}
        >
          <div className={classNames(projectcss.all, sty.freeBox__wu0Rn)}>
            {p.renderPlasmicSlot({
