...
import * as sty from "./PlasmicButton.module.css"; // plasmic-import: PDN2xmv-0aRn/css
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <AppleIcon
                className={classNames(projectcss.all, sty.svg__zuaUn)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <AppleIcon
                className={classNames(projectcss.all, sty.svg__oHjTi)}
                role={"img"}
              />
            ),
