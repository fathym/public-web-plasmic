...
import TextInput2 from "../../TextInput2"; // plasmic-import: 7SVl8zJ-sDMSIw/component
import Button2 from "../../Button2"; // plasmic-import: LBUZCU9Kdy0v0g/component
import IconLink from "../../IconLink"; // plasmic-import: Ep0Bil3jM18PSg/component
...
import * as sty from "./PlasmicFooter.module.css"; // plasmic-import: m0B3ZpmlFE6MA6/css

import SearchIcon from "./icons/PlasmicIcon__Search"; // plasmic-import: eTw_Xt64C6xadZ/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: IxZPn29SdYVEo0/icon
...
function PlasmicFooter__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__iYTl)} />

      <p.PlasmicImg
        alt={"" as const}
        className={classNames(sty.img__xqKUs)}
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__k4Gze)}
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__hm6JD)}
        >
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox___16U5N)}
          >
            <div
              className={classNames(
                projectcss.all,
          ...
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__yiAou)}
          >
            <div
              className={classNames(
                projectcss.all,
          ...
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__c71Kg)}
          >
            <div
              className={classNames(
                projectcss.all,
          ...
          {true ? (
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox___1X2Mr)}
            >
              <div
                className={classNames(
                  projectcss.all,
              ...
              <TextInput2
                ...
                endIcon={
                  <Button2
                    ...
                    startIcon={
                      <IconIcon
                        className={classNames(projectcss.all, sty.svg___6QPiW)}
                        role={"img"}
                      />
                    }
                  >
                    <IconIcon
                      className={classNames(projectcss.all, sty.svg__taI6M)}
                      role={"img"}
                    />
                  </Button2>
                }
      ...
      <div className={classNames(projectcss.all, sty.freeBox___7Ue0)} />

      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__rOwer)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__yJ7Lx)}>
          <div
            className={classNames(
              projectcss.all,
              projectcss.__wab_text,
          ...
          <p.PlasmicImg
            alt={""}
            className={classNames(sty.img__zDb4O)}
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__lHY)}
        >
          <IconLink
