...
import * as sty from "./PlasmicListItem.module.css"; // plasmic-import: 4uJ3KR5liNj7zD/css

import CheckCircleIcon from "./icons/PlasmicIcon__CheckCircle"; // plasmic-import: 5ZOAf7OyUQuCfy/icon
  ...
  return (
    ...
    >
      ...
      {p.renderPlasmicSlot({
        defaultContents: (
          <CheckCircleIcon
            className={classNames(projectcss.all, sty.svg___48L7X)}
            role={"img"}
          />
        ),
