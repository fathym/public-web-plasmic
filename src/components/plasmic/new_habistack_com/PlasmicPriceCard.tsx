...
import ValueProp from "../../ValueProp"; // plasmic-import: gkoJPq9DLAIi7z/component
...
import * as sty from "./PlasmicPriceCard.module.css"; // plasmic-import: _z5tqDe8us-Woo/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__vazT8)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__kqGGc)}>
          <div className={classNames(projectcss.all, sty.freeBox__aDWbA)}>
            {p.renderPlasmicSlot({
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__yP0Oe)}
        >
          <div className={classNames(projectcss.all, sty.freeBox__x6HLg)}>
            <div
              className={classNames(
                projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__kKasd)}>
              {p.renderPlasmicSlot({
                defaultContents: "8",
                value: args.dollars,
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___0V8YG)}
      >
        <Button
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__qFbFj)}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <div className={classNames(projectcss.all, sty.freeBox__ci5S7)}>
                <ValueProp
                  className={classNames("__wab_instance", sty.valueProp__zzqj3)}
                  description={"Mus consequat a justo"}
                  icon={
                    <CheckIcon
                      className={classNames(projectcss.all, sty.svg___2KJax)}
                      role={"img"}
                    />
                  }
                />
                ...
                <ValueProp
                  className={classNames("__wab_instance", sty.valueProp___4J8Y)}
                  description={
                    "Vestibulum mollis odio dictum ultrices facilisis molestie vestibulum"
                  }
                  icon={
                    <CheckIcon
                      className={classNames(projectcss.all, sty.svg__b7YMl)}
                      role={"img"}
                    />
                  }
                />
